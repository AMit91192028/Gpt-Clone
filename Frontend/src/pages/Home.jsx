...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post("https://gpt-clone-xv0t.onrender.com/chat", {
      title
    }, {
  ...
  useEffect(() => {
    ...
    const tempSocket = io("https://gpt-clone-xv0t.onrender.com/chat", {
      withCredentials: true,
    })
  ...
  const getMessages = async (chatId) => {
   ...
   const response = await  axios.get(`https://gpt-clone-xv0t.onrender.com/chat/messages/${chatId}`, { withCredentials: true })
